...
y = runif(80)
z = runif(80)
ddst.ksample.test(x, y, z)
ddst.ksample.test(list(x, y, z))
...
w = rnorm(30)
z = rexp(10, 1)
ddst.ksample.test(x, y, w, z)
ddst.ksample.test(list(x, y, w, z))
```
...
y = runif(80)
z = runif(80)
ddst.umbrella.test(x, y, z)
ddst.umbrella.test(list(x, y, z))
